// https://www.youtube.com/watch?v=zmWkhlocBRY
...
public class Explorer : MonoBehaviour
{
    ...
    private void HandleInputs()
    {
        ...
        if (Input.GetKey(KeyCode.Q)) angle -= .01f * scale;
        if (Input.GetKey(KeyCode.E)) angle += .01f * scale;
    ...
    private void UpdateShader()
    {
        ...
        mat.SetVector("_Area", new Vector4(
            smoothPos.x,
            smoothPos.y,
            scaleX,
            scaleY));
